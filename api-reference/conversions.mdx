...
Reject a conversion (e.g., for refunds or cancellations). Only works during the maturation period.
...
Restore a previously rejected conversion (e.g., if a refund was cancelled). Only works during the maturation period.

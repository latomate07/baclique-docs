...
- If the email is already a BaClique user → Added immediately as affiliate
- If email is NOT a BaClique user → Returns `404: User not found. They must have a BaClique account.`
